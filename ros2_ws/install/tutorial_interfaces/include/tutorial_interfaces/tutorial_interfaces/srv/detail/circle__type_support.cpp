...
{
  new (message_memory) tutorial_interfaces::srv::Circle_Request(_init);
}

void Circle_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::srv::Circle_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Circle_Request_message_member_array[3] = {
  {
    ...
    offsetof(tutorial_interfaces::srv::Circle_Request, point),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::srv::Circle_Request, linear_vel),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::srv::Circle_Request, radius),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Circle_Request_message_members = {
  ...
  3,  // number of fields
  sizeof(tutorial_interfaces::srv::Circle_Request),
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::Circle_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Circle_Request)() {
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::Circle_Request_message_type_support_handle;
}
...
void Circle_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tutorial_interfaces::srv::Circle_Response(_init);
}

void Circle_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::srv::Circle_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Circle_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tutorial_interfaces::srv::Circle_Response, drawn_rad),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Circle_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tutorial_interfaces::srv::Circle_Response),
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::Circle_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Circle_Response)() {
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::Circle_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Circle_service_members = {
  ...
  // see get_service_type_support_handle<tutorial_interfaces::srv::Circle>()
...
get_service_type_support_handle<tutorial_interfaces::srv::Circle>()
{
  ...
  auto service_type_support =
    &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::Circle_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, Circle)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tutorial_interfaces::srv::Circle>();
}
