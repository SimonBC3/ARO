...
{
  new (message_memory) tutorial_interfaces::srv::MoveRobot_Request(_init);
}

void MoveRobot_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::srv::MoveRobot_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MoveRobot_Request_message_member_array[1] = {
  {
    ...
    offsetof(tutorial_interfaces::srv::MoveRobot_Request, objective_point),  // bytes offset in struct
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::MoveRobot_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot_Request)() {
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::MoveRobot_Request_message_type_support_handle;
}
...
void MoveRobot_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) tutorial_interfaces::srv::MoveRobot_Response(_init);
}

void MoveRobot_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tutorial_interfaces::srv::MoveRobot_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MoveRobot_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(tutorial_interfaces::srv::MoveRobot_Response),
...
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::MoveRobot_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot_Response)() {
  return &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::MoveRobot_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers MoveRobot_service_members = {
  ...
  // see get_service_type_support_handle<tutorial_interfaces::srv::MoveRobot>()
...
get_service_type_support_handle<tutorial_interfaces::srv::MoveRobot>()
{
  ...
  auto service_type_support =
    &::tutorial_interfaces::srv::rosidl_typesupport_introspection_cpp::MoveRobot_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<tutorial_interfaces::srv::MoveRobot>();
}
