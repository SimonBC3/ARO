...
#include "tutorial_interfaces/srv/detail/circle__rosidl_typesupport_fastrtps_c.h"
...
using _Circle_Request__ros_msg_type = tutorial_interfaces__srv__Circle_Request;
...
static uint32_t _Circle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__Circle_Request(
...
static size_t _Circle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__Circle_Request(
...
using _Circle_Response__ros_msg_type = tutorial_interfaces__srv__Circle_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tutorial_interfaces__srv__Circle_Response(
      untyped_ros_message, 0));
}
...
static size_t _Circle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tutorial_interfaces__srv__Circle_Response(
    full_bounded, is_plain, 0);
...
// already included above
// #include "tutorial_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tutorial_interfaces/srv/circle.h"
