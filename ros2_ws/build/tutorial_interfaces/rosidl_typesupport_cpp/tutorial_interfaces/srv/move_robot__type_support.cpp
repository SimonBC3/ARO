...
static const _MoveRobot_Request_type_support_symbol_names_t _MoveRobot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, MoveRobot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot_Request)),
  }
};
...
get_message_type_support_handle<tutorial_interfaces::srv::MoveRobot_Request>()
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::MoveRobot_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, MoveRobot_Request)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::MoveRobot_Request>();
}
...
static const _MoveRobot_Response_type_support_symbol_names_t _MoveRobot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, MoveRobot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<tutorial_interfaces::srv::MoveRobot_Response>()
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::MoveRobot_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tutorial_interfaces, srv, MoveRobot_Response)() {
  return get_message_type_support_handle<tutorial_interfaces::srv::MoveRobot_Response>();
}
...
static const _MoveRobot_type_support_symbol_names_t _MoveRobot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tutorial_interfaces, srv, MoveRobot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tutorial_interfaces, srv, MoveRobot)),
  }
};
...
get_service_type_support_handle<tutorial_interfaces::srv::MoveRobot>()
{
  return &::tutorial_interfaces::srv::rosidl_typesupport_cpp::MoveRobot_service_type_support_handle;
}
